  ...
  const products = [
    {
      ...
      description:
        "A comprehensive computer vision platform that enables businesses to extract insights from images and video with unprecedented accuracy.",
      features: [
    ...
    },
    {
      ...
      description:
        "Transform how your business handles text data with our state-of-the-art natural language processing solution.",
      features: [
    ...
    },
    {
      ...
      description:
        "Harness the power of predictive modeling to forecast trends, behaviors, and outcomes with remarkable accuracy.",
      features: [
    ...
    },
    {
      ...
      description:
        "Streamline operations and reduce costs with our AI-powered automation platform designed for enterprise workflows.",
      features: [
    ...
    },
    {
      ...
      description:
        "Turn your raw data into actionable insights with our comprehensive analytics solution powered by machine learning.",
      features: [
    ...
    },
    {
      ...
      description:
        "Create intelligent chatbots and virtual assistants that understand context and deliver personalized experiences.",
      features: [
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
              Cutting-edge AI solutions designed to solve real business
              challenges
            </p>
          </div>
        </div>
                      ...
                      {product.features.map((feature, i) => (
                        <li key={i} className="flex items-start">
                          <svg
                            ...
                            className="h-5 w-5 text-primary dark:text-primary-light mr-2 mt-0.5"
                            viewBox="0 0 20 20"
                            fill="currentColor"
                          >
                            <path
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Our products are designed to work with your existing technology
              stack
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8">
            {[
              ...
              <div
                key={index}
                className="bg-white dark:bg-dark-light rounded-lg p-4 flex items-center justify-center h-24 shadow-md"
              >
          ...
          {[
            {
              ...
              result:
                "Reduced diagnostic time by 60% with AI-powered medical imaging analysis",
              industry: "Healthcare",
            },
            {
              ...
              product: "PredictAI",
              result:
                "Increased inventory forecasting accuracy by 35%, reducing stockouts by 42%",
              industry: "Retail",
            },
            {
              ...
              product: "NaitifyNLP",
              result:
                "Automated 78% of customer service inquiries, improving response time by 90%",
              industry: "Finance",
            },
          ].map((case_study, index) => (
            <Card key={index} className="p-6" variant="elevated">
              <div className="text-sm font-medium text-primary dark:text-primary-light mb-2">
                {case_study.industry}
              </div>
          ...
          {[
            ...
            <Card
              ...
              className={`overflow-hidden ${
                plan.highlighted
                  ? "border-2 border-primary dark:border-primary-light transform scale-105"
                  : ""
              }`}
      ...
      >
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Schedule a personalized demo with our product specialists to see how
            our AI solutions can transform your business.
          </p>
